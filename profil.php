...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="text-center"><img width="200" src="<?php if(is_file("image/".$vfoto)) { echo "image/".$vfoto; } else { ?>user 1.png<?php } ?>" alt=""></div>
  ...
  <select name="tjenis_kelamin" value="<?=@$vjenis_kelamin?>" class="form-select" id="floatingSelect" aria-label="Floating label select example">
    <option <?php if(isset($vjeniskelamin) && $vjeniskelamin== "") {echo"selected";} ?> value="">Pilih</option>
    <option <?php if(isset($vjeniskelamin) && $vjeniskelamin== "laki-laki") {echo"selected";} ?> value="laki-laki">Laki - Laki</option>
    <option <?php if(isset($vjeniskelamin) && $vjeniskelamin== "perempuan") {echo"selected";} ?> value="perempuan">Perempuan</option>
  </select>
  <label for="floatingSelect">Jenis Kelamin</label>
      ...
      <div class="form-floating mt-3">
        ...
        <a id="login" class="btn btn-primary mt-3" href="Ganti-Pass.php" role="button">Ganti Password</a>
