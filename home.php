  ...
  <div class="container">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-4 text-center">
          <a href="produk.html"><img src="baju2.png" width="50">
          <p style="font-size: 8px;">Nama Barang</p></a>
        </div>
        <div class="col-4 text-center">
          <a href=""><img src="cake.png" width="50">
          <p style="font-size: 8px;">Nama Barang</p></a>
        </div>
        <div class="col-4 text-center">
          <a href=""><img src="snack 4.png" width="50">
          <p style="font-size: 8px;">Nama Barang</p></a>
        </div>
        <div class="col-4 text-center">
          <a href=""><img src="breakfast 2.png" width="50">
          <p style="font-size: 8px;">Nama Barang</p></a>
        </div>
        <div class="col-4 text-center">
          <a href=""><img src="snack 3.png" width="50">
          <p style="font-size: 8px;">Nama Barang</p></a>
        </div>
      </div>
      </div>
      ...
      <a href="deskripsi.php" class="btn btn" role="button"> <i class="bi bi-cart4"></i> <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css"></i></button>
